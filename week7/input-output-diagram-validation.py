...
Verification Report
Installed System
Transition Report""".split("\n")

activities = [ "Prepare for Validation",
               "Perform Validation",
               "Manage Results of Validation" ]

outputs =  """Validation Strategy/Approach
Validation Criteria
Validation Procedure
Validated Stakeholder Needs and Requirements
Validated System Architecture and Design
Validated System
...
Validation Report
Validation Records/Artifacts""".split("\n")
...
diagram.format = 'svg'
diagram.render( 'ipo-diag-validation')
